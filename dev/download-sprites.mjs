...
zip.getEntries().forEach(function(entry) {
    ...
    //extract the sprite, and convert it to webp and put it into the public/isoncs folder
    if (matches !== null) {
        sharp(entry.getData()).webp().toFile(`../public/icons/${matches[2]}${((matches[1] == 'shiny') ? '-shiny' : '')}.webp`);
    }
